...
DATAPATH = "Delta_SusAd_Task2/SuperUser Mode/src/studentDetails.txt"
...
def dept(rollno):
    first4 = rollno[:4]
    if first4 == "106": return "CSE"
    elif first4 == "103": return "CIV"
    elif first4 == "102": return "CHE"
    elif first4 == "107": return "EEE"
    elif first4 == "108": return "ECE"
    elif first4 == "110": return "ICE"
    elif first4 == "111": return "MEC"
    elif first4 == "112": return "MME"
    elif first4 == "114": return "ARC"
    elif first4 == "101": return "PRO"
    else: return "NA"

def current_year(rollno):
    from datetime import date 
    year_ = date.today().year
    year_of_joining=int(rollno[5:7])
    return year_-year_of_joining+1
    ...
    with open(DATAPATH) as f:
        ...
        for line in f:
            ...
            cursor.execute(
                ...
                (l[1], l[0], l[2], l[3], l[4], l[5], dept(l[1]), current_year(l[1]))
            )
            conn.commit()
